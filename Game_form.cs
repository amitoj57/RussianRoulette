...
namespace RussianRoulette
{
    public partial class Game_form : Form
    {
        ...
        private void Game_form_Load_1(object sender, EventArgs e)
        {
        ...
        private void btn_load_Click_1(object sender, EventArgs e)
        {
            ...
            Stream Str = Assem.GetManifestResourceStream("RussianRoulette.Resources.load1.gif");
            Bitmap bmpObj = new Bitmap(Str);
            picbox_main.Image = bmpObj;

            //code helps for sounds//
            System.Media.SoundPlayer sndObj = new System.Media.SoundPlayer(RussianRoulette.Properties.Resources.gun_load1);
            sndObj.Play();
        ...
        private void btn_spin_Click_1(object sender, EventArgs e)
        {
            ...
            Assembly Assem = Assembly.GetExecutingAssembly();
            Stream Str = Assem.GetManifestResourceStream("RussianRoulette.Resources.spin.gif");
            Bitmap bmpObj = new Bitmap(Str);
            picbox_main.Image = bmpObj;
        ...
        private void btn_shoot_Click_1(object sender, EventArgs e)
        {
            //below code helps to show the image
            //coding for images//
            Assembly Assem = Assembly.GetExecutingAssembly();
            Stream Str = Assem.GetManifestResourceStream("RussianRoulette.Resources.shoot1.gif");
            Bitmap bmpObj = new Bitmap(Str);
            picbox_main.Image = bmpObj;

            //coding for sounds//
            System.Media.SoundPlayer sndObj = new System.Media.SoundPlayer(RussianRoulette.Properties.Resources.gun_shoot);
            sndObj.Play();
        ...
        private void btn_shootaway_Click_1(object sender, EventArgs e)
        {
            //coding helps for image//
            Assembly Assem = Assembly.GetExecutingAssembly();
            Stream Str = Assem.GetManifestResourceStream("RussianRoulette.Resources.shootaway.gif");
            Bitmap bmpObj = new Bitmap(Str);
            picbox_main.Image = bmpObj;
        ...
        private void btn_gamerules_Click(object sender, EventArgs e)
        {
